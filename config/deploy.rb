...
set :application_name, 'PagesApp'
set :repository, 'git@github.com:ragnarook83/PagesApp.git'
...
task :testing do
  ...
  set :deploy_to, '/home/testing/apps/pagesapp'
